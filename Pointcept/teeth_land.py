...
#         data_dict["segment"] = data_dict["segment"].astype(np.float32)
#         return data_dict
#
...
if __name__ == '__main__':
    ...
    data_root= '/data2/lwj/PycharmProjects/new/ourseg_test'
    pred_root = '/data2/lwj/PycharmProjects/MICCAI_TeethLand24/Pointcept/exp/teeth_land/semseg-pt-v3m1-0-base/result'
    save_root = '/data2/lwj/PycharmProjects/MICCAI_TeethLand24/Pointcept/exp/teeth_land/semseg-pt-v3m1-0-base/result_test_norm_new'
    ...
    for file_name in os.listdir(pred_root):
        ...
        cls_id = file_name.split('_')[1]
        teeth_id = file_name.split('_')[2]
        data_path = os.path.join(data_root, cls_id, model_id, teeth_id+'.txt')
        if not os.path.exists(data_path):
            continue
        num += 1
        pc = np.loadtxt(data_path)[:, :3]
