...
Note: The final checkpoint is now available and exists in the “/Pointcept/exp/teeth_land/semseg-pt-v3m1-0-base/model/model_best.pth” directory. You can run the fourth step directly