...
class Seq(nn.Sequential):
    ...
    @staticmethod
    def builder(input_channels):
        """
        Builder of this class

        The original method to call constructor as a builder is not good,
        the builder method should be defined & called separately, like SomeCls.builder(params).xxx
        """
        return Seq(input_channels)
